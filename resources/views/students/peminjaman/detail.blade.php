    ...
    <div class="invoice">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 text-md-right">
                            <span style="font-size: 16px">{{ $loan->student->nama }}</span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6 text-md-right">
                            <span style="font-size: 16px">{{ $loan->student->classroom->nama }}</span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            {!! QrCode::size(100)->generate($loan->id) !!}
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-md">
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{ $loan->book->rack->nama }}</td>
                                <td class="text-center">{{ $loan->book->category->nama }}</td>
                                <td class="text-center">{{ $loan->book->pengarang }}</td>
                                <td class="text-center">{{ $loan->book->penerbit }}</td>
                                <td class="text-center">{{ $loan->book->tahun_terbit }}</td>
                            </tr>
                        </table>
                    </div>
                </div>
        ...
        <div class="text-md-right">
            <div class="float-lg-left mb-lg-0 mb-3">
                <a href="/dashboard/siswa/transaksi/peminjaman" class="btn btn-danger btn-icon icon-left">
                    Kembali</a>
            </div>
        </div>
    </div>
