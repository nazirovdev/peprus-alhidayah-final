                    ...
                    <tbody>
                        ...
                        @foreach ($loans as $loan)
                            <tr>
                                ...
                                <td>
                                    <a href="/dashboard/siswa/transaksi/peminjaman/detail/{{ $loan->id }}"
        ...
        btnDeleteData.forEach(btnDelete => {
            btnDelete.addEventListener('click', function(e) {
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            fetch(`${window.location.origin}/dashboard/siswa/transaksi/peminjaman/delete/${this.getAttribute('data-id')}`, {
                                method: 'DELETE',
                                headers: {
                            ...
                            swal('Data berhasil dihapus!', {
                                ...
                                window.location.href =
                                    `${window.location.origin}/dashboard/siswa/transaksi/peminjaman`
                            });
