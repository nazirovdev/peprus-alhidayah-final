...
<div class="row">
    <div class="col-12">
        ...
        <!-- <a class="btn btn-sm btn-primary mb-4" href="/peminjaman/export/pdf">
            ...
            <table class="table table-bordered table-md">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{ $loan->student->nama }}</td>
                        ...
                        <div class="row gx-5" style="gap: 40px">
                            <div class="col-12">
                                <div class="form-group row mb-4">
                                    ...
                                    <a href="/peminjaman/export/template">Unduh Template untuk data
                                        {{ $title }}</a>
                                </div>
                            </div>
                        </div>
