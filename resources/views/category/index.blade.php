...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            ...
            @endif
            <a class="btn btn-sm btn-primary mb-4" href="/kategori/tambah">
                        ...
                        @forelse ($categories as $category)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="/kategori/{{ $category->id }}" class="btn btn-warning">
                                        <i>
                                    ...
                                    <button class="btn btn-danger btn-delete-data" data-id="{{ $category->id }}">
                                        <i>
                                            <svg xmlns="http://www.w3.org/2000/svg"
        ...
        btnDeleteData.forEach(btnDelete => {
            btnDelete.addEventListener('click', function(e) {
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            fetch(`${window.location.origin}/kategori/delete/${this.getAttribute('data-id')}`, {
                                method: 'DELETE',
                                headers: {
                            ...
                            swal('Data berhasil dihapus!', {
                                ...
                                window.location.href = `${window.location.origin}/kategori`
                            });
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="section-header">
                    <form class="card-body" action="/kategori/import" method="POST" enctype="multipart/form-data">
                        @csrf()
                        <div class="row gx-5" style="gap: 40px">
                            <div class="col-12">
                                <div class="form-group row mb-4">
                                    ...
                                    <a href="/kategori/export/template">Unduh Template untuk data
                                        {{ $title }}</a>
                                </div>
                            </div>
                        </div>
