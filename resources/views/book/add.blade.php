                ...
                <div class="row" style="justify-content: space-between; gap: 10px; flex-wrap: wrap">
                    <div class="col-12">
                        <div class="form-group row mb-4">
                            ...
                            <input type="text" class="form-control" placeholder="Masukkan ISBN" name="isbn" value="{{ old('isbn') }}" id="isbn">
                            @error('isbn')
                    ...
                    <div class="col-12">
                        <div class="form-group row mb-4">
                            ...
                            <input type="text" class="form-control" placeholder="Masukkan Judul Buku" name="judul" value="{{ old('judul') }}" id="judul">
                            @error('judul')
                            <span style="font-style: italic; color: red; font-weight: bold;">
                                {{ $message }}
                            </span>
                    ...
                    <div class="col-12">
                        <div class="form-group row mb-4">
                            ...
                            <input type="number" class="form-control" placeholder="Masukkan Jumlah Buku" name="jumlah" value="{{ old('jumlah') }}" id="jumlah">
                            @error('jumlah')
                            <span style="font-style: italic; color: red; font-weight: bold;">
                                {{ $message }}
                            </span>
                    ...
                    <div class="col-12 col-md-3">
                        <div class="form-group row mb-4">
                            ...
                            <input type="text" class="form-control" placeholder="Masukkan Pengarang" name="pengarang" value="{{ old('pengarang') }}" id="pengarang">
                            @error('pengarang')
                            <span style="font-style: italic; color: red; font-weight: bold;">
                                {{ $message }}
                            </span>
                    ...
                    <div class="col-12 col-md-3">
                        <div class="form-group row mb-4">
                            ...
                            <input type="text" class="form-control" placeholder="Masukkan Penerbit" name="penerbit" value="{{ old('penerbit') }}" id="penerbit">
                            @error('penerbit')
                            <span style="font-style: italic; color: red; font-weight: bold;">
                                {{ $message }}
                            </span>
                    ...
                    <div class="col-12 col-md-3">
                        <div class="form-group row mb-4">
                            <label class="col-form-label" style="font-size: 16px;" for="tahun_terbit">Tahun
                                Terbit</label>
                            <input type="text" class="form-control" placeholder="Masukkan Tahun Terbit" name="tahun_terbit" value="{{ old('tahun_terbit') }}" id="tahun_terbit">
                            @error('tahun_terbit')
                            <span style="font-style: italic; color: red; font-weight: bold;">
                                {{ $message }}
                            </span>
                    ...
                    <div class="col-12">
                        <div class="form-group row mb-4">
                            <label class="col-form-label" style="font-size: 16px;" for="tanggal_masuk">Tanggal
                                Masuk</label>
                            <input type="date" class="form-control" placeholder="Masukkan Tanggal Masuk" name="tanggal_masuk" value="{{ old('tanggal_masuk') }}" id="tanggal_masuk">
                            @error('tanggal_masuk')
                            <span style="font-style: italic; color: red; font-weight: bold;">
                                {{ $message }}
                            </span>
                    ...
                    <div class="form-group row mb-4 col-12">
                        ...
                        <div class="col-12 p-0">
                            <label style="width: 200px; height: 230px;border-width: 2px; border-color: gray; border-style: dashed; padding: 3px" for="upld">
                                <img style="display: block; width: 100%; height: 100%;object-fit: cover" src="{{ asset('assets/images/default.jpg') }}" class="img-upld" />
