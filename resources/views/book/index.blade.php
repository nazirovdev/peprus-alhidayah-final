...
<div class="row">
    <div class="col-12">
        ...
        @endif
        <a class="btn btn-sm btn-primary mb-4" href="/buku/tambah">
        ...
        <button type="button" class="btn btn-sm mb-4" data-toggle="modal" data-target="#exampleModal" style="background-color: #22c55e; color: white">
        ...
        <a href="/laporan/buku/qrcode" class="btn btn-sm mb-4" style="background-color: #22c55e; color: white">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="#" class="badge {{ $book->jumlah > 0 ? 'badge-success' : 'badge-danger' }}">
                                {{ $book->jumlah > 0 ? 'Tersedia' : 'Kosong' }}
                            </a>
                        </td>
                        <td class="text-center">
                            <a href="/buku/{{ $book->id }}" class="btn btn-warning">
                                <i>
                            ...
                            <button class="btn btn-danger btn-delete-data" data-id="{{ $book->id }}">
                                <i>
    ...
    btnDeleteData.forEach(btnDelete => {
        btnDelete.addEventListener('click', function(e) {
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        fetch(`${window.location.origin}/buku/delete/${this.getAttribute('data-id')}`, {
                            method: 'DELETE',
                            headers: {
                        ...
                        swal('Data berhasil dihapus!', {
                            ...
                            window.location.href = `${window.location.origin}/buku`
                        });
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="section-header">
                    <form class="card-body" action="/buku/import" method="POST" enctype="multipart/form-data">
                        @csrf()
                        <div class="row gx-5" style="gap: 40px">
                            <div class="col-12">
                                <div class="form-group row mb-4">
                                    <label style="width: 100%; padding: 0 10px;height:40px; border-width: 2px; border-color: gray; border-style: dashed;" for="upld">
                                        <p style="line-height: 40px" class="text-upld-classroom">Upload</p>
                                        <input type="file" name="file" id="upld" style="display: none" class="input-upld-classroom">
                                    </label>
                                    <a href="/buku/export/template">Unduh Template untuk data
                                        {{ $title }}</a>
                                </div>
                            </div>
                        </div>
