...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            ...
            @endif
            <a class="btn btn-sm btn-primary mb-4" href="/siswa/tambah">
                    ...
                    <tbody>
                        ...
                        @forelse ($students as $student)
                            <tr>
                                ...
                                <td class="text-center">{{ $student->classroom->nama }}</td>
                                {{-- <td class="text-center">
                                    <a href="#"
                                        class="badge {{ $student->status == 'member' ? 'badge-success' : 'badge-warning' }}">
                                        {{ $student->status }}
                                    </a>
                                </td> --}}
                                <td class="text-center">
                                    <a href="/siswa/{{ $student->id }}" class="btn btn-warning">
                                        <i>
                                    ...
                                    <button class="btn btn-danger btn-delete-data" data-id="{{ $student->id }}">
                                        <i>
                                            <svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="row gx-5" style="gap: 40px">
                            <div class="col-12">
                                <div class="form-group row mb-4">
                                    ...
                                    <a href="/siswa/export/template">Unduh Template untuk data {{ $title }}</a>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
